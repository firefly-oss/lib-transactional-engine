...
class SagaEngineCompensationPolicyTest {
    ...
    void groupedParallelCompensationIsFasterThanSequential() {
        ...
        StepHandler<Void, String> a = new StepHandler<Void, String>() {
            @Override public Mono<String> execute(Void input, com.catalis.transactionalengine.core.SagaContext ctx) { return Mono.just("ra"); }
            @Override public Mono<Void> compensate(Object arg, com.catalis.transactionalengine.core.SagaContext ctx) { return Mono.delay(Duration.ofMillis(200)).then(); }
        };
        StepHandler<Void, String> b = new StepHandler<Void, String>() {
            @Override public Mono<String> execute(Void input, com.catalis.transactionalengine.core.SagaContext ctx) { return Mono.just("rb"); }
            @Override public Mono<Void> compensate(Object arg, com.catalis.transactionalengine.core.SagaContext ctx) { return Mono.delay(Duration.ofMillis(200)).then(); }
        };
        StepHandler<Void, String> c = new StepHandler<Void, String>() {
            @Override public Mono<String> execute(Void input, com.catalis.transactionalengine.core.SagaContext ctx) { return Mono.just("rc"); }
            @Override public Mono<Void> compensate(Object arg, com.catalis.transactionalengine.core.SagaContext ctx) { return Mono.delay(Duration.ofMillis(200)).then(); }
        };
