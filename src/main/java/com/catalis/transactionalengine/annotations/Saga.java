 ...
 * the typed {@code execute(...)} API that works with {@link com.catalis.transactionalengine.engine.StepInputs} and
 * returns a typed {@link com.catalis.transactionalengine.core.SagaResult}.
 */
