...
package com.firefly.transactional.annotations;
 ...
 * the typed {@code execute(...)} API that works with {@link com.firefly.transactional.engine.StepInputs} and
 * returns a typed {@link com.firefly.transactional.core.SagaResult}.
 */
