...
package com.firefly.transactional.tcc.composition;

import java.util.Objects;

/**
 * Represents a validation issue found during TCC composition building.
 * <p>
 ...
 * developers quickly resolve issues in TCC compositions.
 */
public class ValidationIssue {
    ...
    /**
     * Creates an error validation issue for a specific TCC.
     */
    public static ValidationIssue error(String code, String message, String suggestion, String tccId) {
        return new ValidationIssue(Severity.ERROR, code, message, suggestion, tccId, null);
    }
    ...
    /**
     * Creates a warning validation issue for a specific TCC.
     */
    public static ValidationIssue warning(String code, String message, String suggestion, String tccId) {
        return new ValidationIssue(Severity.WARNING, code, message, suggestion, tccId, null);
    }
    ...
    /**
     * Creates an info validation issue for a specific TCC.
     */
    public static ValidationIssue info(String code, String message, String suggestion, String tccId) {
        return new ValidationIssue(Severity.INFO, code, message, suggestion, tccId, null);
    }
    ...
    public String getTccId() { return tccId; }
    ...
    public String getFormattedMessage() {
        ...
        if (tccId != null) {
            sb.append(" (tcc: ").append(tccId).append(")");
        }
    ...
    public boolean equals(Object o) {
        ...
        return severity == that.severity &&
               ...
               Objects.equals(tccId, that.tccId) &&
               Objects.equals(location, that.location);
    }
    
    @Override
    public int hashCode() {
        return Objects.hash(severity, code, message, tccId, location);
    }
}
