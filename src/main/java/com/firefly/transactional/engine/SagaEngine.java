...
import com.firefly.transactional.core.*;
...
import com.firefly.transactional.tools.MethodRefs;
 ...
 * - Store step results in {@link com.firefly.transactional.core.SagaContext} under the step id.
...
public class SagaEngine {
    ...
    public Mono<SagaResult> execute(SagaDefinition saga, StepInputs inputs, SagaContext ctx) {
        ...
        final com.firefly.transactional.core.SagaContext finalCtx =
    ...
    private Mono<Void> persistInitialState(SagaDefinition saga, StepInputs inputs, SagaContext context) {
        ...
        SagaExecutionState initialState = new SagaExecutionState.Builder()
                ...
                .sagaName(saga.name)
                .status(com.firefly.transactional.persistence.SagaExecutionStatus.RUNNING)
    ...
    private Mono<Void> persistFinalState(SagaContext context, boolean successful) {
        ...
        var finalStatus = successful ?
            com.firefly.transactional.persistence.SagaExecutionStatus.RUNNING : // Will be updated to COMPLETED_SUCCESS by markSagaCompleted
            com.firefly.transactional.persistence.SagaExecutionStatus.FAILED;
