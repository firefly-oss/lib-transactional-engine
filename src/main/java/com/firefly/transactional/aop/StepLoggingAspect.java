...
package com.firefly.transactional.aop;
...
public class StepLoggingAspect {
    ...
    @Around("@annotation(com.firefly.transactional.annotations.SagaStep) || @annotation(com.firefly.transactional.annotations.ExternalSagaStep)")
    public Object aroundSagaStep(ProceedingJoinPoint pjp) throws Throwable {
        ...
        if (ann != null) {
            ...
            var ext = ms.getMethod().getAnnotation(com.firefly.transactional.annotations.ExternalSagaStep.class);
