...
package com.firefly.transactional.saga.annotations;
 ...
 * Classes annotated with {@link Saga} are discovered by {@link com.firefly.transactional.registry.SagaRegistry}
 * at application startup.
 * <p>
 * Note: Older {@code run(...)} overloads still exist for backward compatibility but are deprecated in favor of
 * the typed {@code execute(...)} API that works with {@link com.firefly.transactional.saga.engine.StepInputs} and
 * returns a typed {@link com.firefly.transactional.saga.core.SagaResult}.
 */
