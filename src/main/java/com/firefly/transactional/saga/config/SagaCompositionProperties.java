...
package com.firefly.transactional.saga.config;
...
/**
 * Configuration properties for Saga Composition functionality.
 * <p>
 * Provides comprehensive configuration options for composition behavior,
 ...
 * </pre>
 */
@ConfigurationProperties(prefix = "firefly.saga.composition")
public class SagaCompositionProperties {
    
    /**
     * Whether saga composition functionality is enabled.
     */
    private boolean enabled = true;
    
    /**
     * Default timeout for saga execution within compositions.
     */
    private Duration defaultTimeout = Duration.ofSeconds(30);
    
    /**
     * Maximum number of sagas that can execute in parallel within a composition.
     */
    private int maxParallelSagas = 10;
    ...
    public int getMaxParallelSagas() { return maxParallelSagas; }
    public void setMaxParallelSagas(int maxParallelSagas) { this.maxParallelSagas = maxParallelSagas; }
    ...
    public static class DevToolsProperties {
        ...
        private String visualizationEndpoint = "/actuator/saga-composition/visualize";
    ...
    public static class PerformanceProperties {
        private boolean sagaPreloading = true;
        ...
        // Getters and setters
        public boolean isSagaPreloading() { return sagaPreloading; }
        public void setSagaPreloading(boolean sagaPreloading) { this.sagaPreloading = sagaPreloading; }
